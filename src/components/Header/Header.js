...
const Header = () => {
    ...
    const [cartFadeIn, setCartFadeIn] = useState(false);
    const [cartFadeOut, setCartFadeOut] = useState(false);
    const [cartLayoutHover, setCartLayoutHover] = useState(false)

    const [fadeIn, setFadeIn] = useState(false);
    const [menuHidden, setMenuHidden] = useState(false);

    const [fadeOut, setFadeOut] = useState(false);
    const [layoutDisplay, setLayoutDisplay] = useState(false);
    ...
    const openMenu = (item) => {
        ...
        setListCategories([...data[index].list]);
    ...
    useEffect(() => {
        const squares = [...containerRef.current.querySelectorAll(".categories")];
        ...
        <div className="header">
            <div className="header-medium">
                <div className="header-top">
                    <Slider {...settings} className="header-top--slider">
                        {/* get data discount from be */}
                        <div>
                            <p>SEE WHAT'S NEW AS OUR STORES REOPEN</p>
                        </div>
                        <div>
                            <p>30% Off $100+. Use code: HEY2021</p>
                        </div>
                        <div>
                            <p>Extra 50% Off Sale Styles. Use code: LASTCALL</p>
                        </div>
                        <div>
                            <p>20% off + free shipping on your first order!</p>
                        </div>
                        <div>
                            <p>Free ground shipping on orders of $150+</p>
                        </div>
                        <div>
                            <p>THE BEST OF LEVI'S - NOW ON OUR APP</p>
                        </div>
                    </Slider>
